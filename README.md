# Привет, я Бакыров Максат Азаматович! 👋
...
## 🛠 Мои проекты
- **[ADI_project](https://github.com/maksat200/ADI_project):** Разработка программного решения (описание вашего проекта).
- **[elements](https://github.com/maksat200/elements):** Работа с элементами и кодом.
- **[tradebook](https://github.com/maksat200/tradebook):** (Если это проект по трейдингу или документации — добавьте кратко).
